...
def studentPortfolio():
    ...
    '''Query tables'''
    ela_pictures = languageArtsPics.query.filter_by(elapxUserID=current_user.accountTableID).all()
    hist_pictures = historyPics.query.filter_by(histpxUserID=current_user.accountTableID).all()
    mth_pictures = mathPics.query.filter_by(mthpxUserID=current_user.accountTableID).all()
    sci_pictures = sciencePics.query.filter_by(scipxUserID=current_user.accountTableID).all()
    soc_pictures = socialStudiesPics.query.filter_by(socpxUserID=current_user.accountTableID).all()
    ...
    return render_template('studentPortfolio.html', currentUser = current_user, 
                           pictures = pictures, 
                           studentFN = studentFN,
